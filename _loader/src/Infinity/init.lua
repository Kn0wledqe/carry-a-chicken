...
local PREFIX_PATHS = {
  ...
  --  ['server'] = game.ServerScriptService,
   -- ['client'] = game.Players.LocalPlayer.PlayerScripts
}

if run_svc:IsServer() then
    PREFIX_PATHS ['server'] = game.ServerScriptService
elseif run_svc:IsClient() then
    PREFIX_PATHS['client'] = game.Players.LocalPlayer.PlayerScripts
